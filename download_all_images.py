...
queries = [
    # North India
    ("Taj_Mahal", "images/hero/north_1.webp"),
    ("Hawa_Mahal", "images/hero/north_2.webp"),
    ("Harmandir_Sahib", "images/hero/north_3.webp"),
    ("Qutb_Minar", "images/hero/north_4.webp"),
    # Hotels
    ("Hotel_room", "images/hero/hotel_deluxe.webp"),
    ("Luxury_hotel", "images/hero/hotel_super_deluxe.webp"),
    ("Resort", "images/hero/hotel_star.webp")
]
